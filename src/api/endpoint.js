...
export const ENDPOINTS = {
  ...
  vendors: {
    list:   '/users/api/v3/vendors',
    get:    (id) => `/users/api/v3/vendors/${enc(id)}`,
    create: '/users/api/v3/vendors/create',
    update: (id) => `/users/api/v3/vendors/${enc(id)}`,
    remove: (id) => `/users/api/v3/vendors/${enc(id)}`,
    users:  (id) => `/users/api/v3/vendors/${enc(id)}/users`,
  },

  divisions: {
    list: '/master/api/v3/divisions',
  },
  ...
  resourceTypes: {
    list: '/master/api/v3/resource_types',
  },

  priorities: {
    list: '/master/api/v3/priorities',
  },
  ...
  projects: {
    list:            '/pmis/api/v3/projects',
    get:             (uuid) => `/pmis/api/v3/projects/${enc(uuid)}`,
    tree:            (uuid) => `/pmis/api/v3/projects/${enc(uuid)}/tree`,
    create:          '/pmis/api/v3/projects/create',
    update:          (uuid) => `/pmis/api/v3/projects/${enc(uuid)}`,
    remove:          (uuid) => `/pmis/api/v3/projects/${enc(uuid)}`,
    save:            (uuid) => `/pmis/api/v3/projects/${enc(uuid)}/save`,
    publish:         (uuid) => `/pmis/api/v3/projects/${enc(uuid)}/publish`,
    close:           (uuid) => `/pmis/api/v3/projects/${enc(uuid)}/close`,
    milestones:      (uuid) => `/pmis/api/v3/projects/${enc(uuid)}/milestones`,
    milestoneCreate: (uuid) => `/pmis/api/v3/projects/${enc(uuid)}/milestones/create`,
    auditLogs:       (uuid) => `/pmis/api/v3/projects/${enc(uuid)}/audit-logs`,
    attachments:     (uuid) => `/pmis/api/v3/projects/${enc(uuid)}/attachments`,
    discussionFeed:  (uuid) => `/pmis/api/v3/projects/${enc(uuid)}/discussion-feed`,
  },

  milestones: {
    update:         (id) => `/pmis/api/v3/milestones/${enc(id)}`,
    remove:         (id) => `/pmis/api/v3/milestones/${enc(id)}`,
    activities:     (id) => `/pmis/api/v3/milestones/${enc(id)}/activities`,
    attachments:    (id) => `/pmis/api/v3/milestones/${enc(id)}/attachments`,
    comments:       (id) => `/pmis/api/v3/milestones/${enc(id)}/comments`,
    // Doc 38: single unified create endpoint (legacy /standard, /transactional,
    // /resource/count, /resource/details paths were removed).
    activityCreate: (milestoneId) =>
      `/pmis/api/v3/milestones/${enc(milestoneId)}/activities/create`,
  },

  activities: {
    get:         (id) => `/pmis/api/v3/activities/${enc(id)}`,
    update:      (id) => `/pmis/api/v3/activities/${enc(id)}`,
    remove:      (id) => `/pmis/api/v3/activities/${enc(id)}`,
    tasks:       (id) => `/pmis/api/v3/activities/${enc(id)}/tasks`,
    taskCreate:  (id) => `/pmis/api/v3/activities/${enc(id)}/tasks/create`,
    attachments: (id) => `/pmis/api/v3/activities/${enc(id)}/attachments`,
    comments:    (id) => `/pmis/api/v3/activities/${enc(id)}/comments`,
  },

  tasks: {
    get:          (id) => `/pmis/api/v3/tasks/${enc(id)}`,
    update:       (id) => `/pmis/api/v3/tasks/${enc(id)}`,
    remove:       (id) => `/pmis/api/v3/tasks/${enc(id)}`,
    subtasks:     (id) => `/pmis/api/v3/tasks/${enc(id)}/subtasks`,
    subtaskCreate:(id) => `/pmis/api/v3/tasks/${enc(id)}/subtasks/create`,
    attachments:  (id) => `/pmis/api/v3/tasks/${enc(id)}/attachments`,
    comments:     (id) => `/pmis/api/v3/tasks/${enc(id)}/comments`,
  },

  subtasks: {
    get:          (id) => `/pmis/api/v3/subtasks/${enc(id)}`,
    update:       (id) => `/pmis/api/v3/subtasks/${enc(id)}`,
    remove:       (id) => `/pmis/api/v3/subtasks/${enc(id)}`,
    subtasks:     (id) => `/pmis/api/v3/subtasks/${enc(id)}/subtasks`,
    subtaskCreate:(id) => `/pmis/api/v3/subtasks/${enc(id)}/subtasks/create`,
    attachments:  (id) => `/pmis/api/v3/subtasks/${enc(id)}/attachments`,
    comments:     (id) => `/pmis/api/v3/subtasks/${enc(id)}/comments`,
  },
