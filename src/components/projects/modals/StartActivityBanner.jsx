/* ══════════════════════════════════════════════════════════════════
   ...
   Two states (mirroring the HTML reference's `.activity-start-banner`):
     • Not started — amber banner with a "▶ Start Activity" button.
       Click stamps `actualStartDate = today` locally. No API call
       here — the approval workflow's single SUBMIT fires later when
       the user clicks "Mark Ready for Approval".
