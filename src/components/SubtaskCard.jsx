...
export default function SubtaskCard({ projectId, taskUid, subtask, editable, expanded, onToggle, onEdit, onRemove }) {
  return (
      ...
      <div className="node-head">
        <div className="node-summary" onClick={onToggle}>
          <div className="node-summary-left">
            ...
            <div className="node-subtitle">{fmtDate(subtask.startDate)} to {fmtDate(subtask.endDate)}</div>
          </div>
      ...
      {expanded && (
        <div className="node-body">
          <div className="grid">
            ...
            <Field label="Description" full><textarea disabled>{subtask.description || ""}</textarea></Field>
